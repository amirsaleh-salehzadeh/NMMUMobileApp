...
//				"Children");
	...
	public static Object invokeMethod(Object obj,String method) throws IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
		...
		try {
			...
			for(int i=list.size()-1;i>=0;i--){
				...
				if(ht.containsKey(keyParent)){
					//StructureNodeDTO parent=(StructureNodeDTO) ht.get(keyParent);
	...
	private static void printObject(Object obj, StringBuffer sb, int level, boolean drillListFields, boolean drillObjectFields, boolean showFullName) {
		String tab = "";
		for (int m = 0; m < level; m++)	tab += "\t";
		if (level > 0)	tab += level + ".";
		if (obj == null) {
			sb.append("{null}");
			return;
		}
		...
		for (int i = 0; i < flds.size(); i++) {
			String firstChar = flds.get(i).getName().substring(0, 1).toUpperCase();
			...
			if(value==null){
				...
				List l = (List) value;
				sb.append("\n>>>" + tab + flds.get(i).getName() + ":" + value.getClass().getSimpleName() + ";");
				for (int j = 0; j < l.size(); j++) {
					sb.append("\n>>>");
					printObject(l.get(j), sb, level + 1, drillListFields, drillObjectFields, showFullName);
				}
				...
				sb.append("]\n<<");
			} else if (drillObjectFields && (value instanceof Integer || value instanceof Double)) {
...
//				}
	...
	public static Object invokeMulti(Object obj,String field) throws IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
		Object v = null;
		if (field.indexOf(".") > -1) {
	...
	public static Object invokeMultiMethod(Object obj,String method) throws IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException{
		Object v = null;
		if (method.indexOf(".") > -1) {
	...
	public static Object invokeGetter(Object obj, String field) throws IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		Object v = obj.getClass().getMethod("get" + field, null).invoke(obj, null);
		return v;
	}

	public static Object invokeSetter(Object obj, String field, String value) throws IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		Object v = obj.getClass().getMethod("set" + field, String.class).invoke(obj, value);
		return v;
	}
	...
	public static Object invoke(Object obj,String field,Object value) throws IllegalArgumentException, SecurityException, IllegalAccessException, InvocationTargetException, NoSuchMethodException, NoSuchFieldException{
		...
		Object v = obj.getClass().getMethod("set"+change2Capital(field),fieldType).invoke(obj, getTypeValue(fieldType,value));
		return v;
	}
