      ...
      awe.util.require([
        {
          ...
          files: [ 
            ['js/awe/awe-standard-dependencies.js', 'js/awe/awe-standard.js'],
            'js/awe/awe-standard-window_resized.js',
            'js/awe/awe-standard-object_clicked.js',
            'js/awe/awe-jsartoolkit-dependencies.js',
            'js/awe/awe.marker_ar.js'
          ],
          success: function() {
