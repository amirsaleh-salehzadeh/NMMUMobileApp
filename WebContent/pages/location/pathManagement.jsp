...
<div id="SettingsMenuBtn">
	<a href="#MenuPanel" class="ui-btn ui-shadow ui-corner-all ui-btn-inline ui-btn-icon-left ui-icon-bars">Settings</a>
<!-- 		<a href="#" class="ui-btn ui-shadow ui-corner-all ui-btn-inline ui-btn-icon-left ui-icon-bars" onclick="showHideSettingsMenu()">Settings</a> -->
</div>
<div id="SettingsMenu">
	...
	data-dismissible="false" data-swipe-close="false"> 
		...
		<div data-role="collapsible" id="IconCollapsible" data-collapsed-icon="carat-d" data-expanded-icon="carat-u" data-content-theme="false">
			<h1>Icon</h1>
...
    		<div class="ui-grid-solo">
		...
		<a href="#" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-a ui-icon-delete ui-btn-icon-left ui-btn-inline">Close Settings</a>
	</div>
</div>
