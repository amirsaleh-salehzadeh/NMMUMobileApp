...
(200, 'N/A', '', 310, '-34.005278450577194,25.67213863134384', 'NMU Summerstrand ', 'admin', 1, NULL),
(200, 'N/A', '', 311, '-34.001492833858435,25.672152042388916', 'North', 'admin', 2, NULL),
(200, 'N/A', '', 312, '-34.009120595618235,25.66856861114502', 'South', 'admin', 2, NULL);
...
--
ALTER TABLE `location`
  MODIFY `location_id` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=313;
--
